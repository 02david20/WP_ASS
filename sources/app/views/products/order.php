                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="flush-headingOne<?php echo $order['id'] . $order_detail['id']; //order_id?>">
                                                <button class="accordion-button collapsed" type="button"
                                                    ...
                                                    data-bs-target="#flush-collapseOne<?php echo $order['id'] . $order_detail['id']; //order_id?>"
                                                    aria-expanded="false"
                                                    aria-controls="flush-collapseOne<?php echo $order['id'] . $order_detail['id']; //order_id?>">
                                                    Sản phẩm #<?php echo $count; $count = $count + 1?>
                                                </button>
                                            </h2>
                                            <div id="flush-collapseOne<?php echo $order['id'] . $order_detail['id']; //order_id?>"
                                                class="accordion-collapse collapse"
                                                aria-labelledby="flush-headingOne<?php echo $order['id'] . $order_detail['id']; //order_id?>"
